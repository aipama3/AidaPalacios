...
serviceTrack?.addEventListener("pointerdown", event => {
  ...
  scrollLeft = serviceTrack.scrollLeft;
});
...
serviceTrack?.addEventListener("pointermove", event => {
  ...
  serviceTrack.scrollLeft = scrollLeft - distance;
});

serviceTrack?.addEventListener("pointerup", () => {
  isDown = false;
});

serviceTrack?.addEventListener("pointercancel", () => {
  isDown = false;
});
